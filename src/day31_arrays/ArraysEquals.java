...
public class ArraysEquals {
    public static void main(String[] args) {
        ...
        System.out.println("cars == cars3 " + Arrays.equals(cars1,cars3));

        if(Arrays.equals(nums1,nums5)) {
            System.out.println("nums1 and nums5 match");
        }else{
            System.out.println("nums1 and nums5 don't match");
